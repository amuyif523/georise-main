...
const severityColors: Record<"HIGH" | "MEDIUM" | "LOW" | "NONE", string> = {
  HIGH:
    "bg-red-600/25 text-red-200 border-red-500/50 shadow-[0_0_18px_rgba(248,113,113,0.55)] animate-pulse",
  MEDIUM: "bg-orange-600/20 text-orange-300 border-orange-500/40 shadow-[0_0_10px_rgba(249,115,22,0.35)]",
