...
const AgenciesPage: React.FC = () => {
  ...
  const saveBoundary = async () => {
    ...
    try {
      await api.patch(`/admin/agencies/${selectedAgency.id}/boundary`, { geojson: boundaryGeoJSON });
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-slate-400">{a.type} • {a.city}</p>
                    </div>
                    <div className="flex flex-col items-end gap-1">
                      <span className={`badge badge-xs ${a.isActive ? "badge-success" : "badge-warning"}`}>
