        ...
        >
            ...
            <div className="card bg-base-200 p-6 space-y-4 mb-8 text-sm">
                ...
                <div className="flex justify-between border-b border-base-content/10 pb-2">
                    ...
                    <span className="font-mono">{draft.latitude?.toFixed(4)}, {draft.longitude?.toFixed(4)}</span>
                </div>
                <div>
            ...
            <button className="btn btn-ghost w-full mt-2" onClick={onBack} disabled={submitting}>Edit Details</button>
        </motion.div>
    );
};
