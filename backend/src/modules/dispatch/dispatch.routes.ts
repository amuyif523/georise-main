...
router.get("/recommend/:incidentId", requireAuth, requireRole(["AGENCY_STAFF", "ADMIN"]), getRecommendations);

// POST /api/dispatch/assign
router.post("/assign", requireAuth, requireRole(["AGENCY_STAFF", "ADMIN"]), assignIncident);

// Optional: auto-assign top candidate
router.post("/auto-assign/:incidentId", requireAuth, requireRole(["AGENCY_STAFF", "ADMIN"]), autoAssignIncident);
